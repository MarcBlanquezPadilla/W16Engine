...
public:
    ...
    bool IsType(ComponentType type) override { return type == ComponentType::Joint || type == ComponentType::PrismaticJoint; };
    ComponentType GetType() override { return ComponentType::PrismaticJoint; };
