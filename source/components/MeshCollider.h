...
public:
    ...
    ComponentType GetType() override { return ComponentType::MeshCollider; }
    bool IsType(ComponentType type) override { return type == ComponentType::Collider || type == ComponentType::MeshCollider; };
