...
public:
    ...
    bool IsType(ComponentType type) override { return type == ComponentType::Joint || type == ComponentType::DistanceJoint; };
    ComponentType GetType() override { return ComponentType::DistanceJoint; };
